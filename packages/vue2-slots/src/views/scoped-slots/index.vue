...
<template>
  <div>
    ...
    <h4 class="case">
      case1 如果子组件中没有写插槽或者没有对应名字的插槽 那父组件就没法替换子组件中的内容
    </h4>
    <p class="case">
      case1-1 子组件中没有插槽 父组件不提供内容
    </p>
    <p>结果: 显示子组件的内容</p>
    <!--        <Child class="case1-1"></Child> -->
    <p class="case">
      case1-2  子组件中没有插槽 父组件提供内容
    </p>
    <p>结果: 显示子组件的内容</p>
    <!--        <Child class="case1-2">我是父组件提供的内容</Child> -->
    <p class="case">
      case1-3  子组件中没有name是footer的插槽 父组件中使用子组件 给子组件中name是footer的插槽提供了内容
    </p>
    <p>结果: 显示子组件的内容</p>
    <!--        <Child class="case1-3"> -->
    <!--          <template #footer> -->
    ...
    <!--        </Child> -->
    <h4 class="case">
      case2 如果子组件中写了插槽 并且 有对应名字的插槽 那父组件可以提供内容 就会替换内容; 也可以不提供内容 就不会替换内容
    </h4>
    <p class="case">
      case2-1 默认内容
    </p>
    ...
    <p class="case">
      case2-3-1 默认插槽 传一个值 父组件不接收数据 只提供内容替换内容
    </p>
    ...
    <p class="case">
      case2-3-2 默认插槽 传一个值 父组件接收一个对象并渲染 提供内容替换内容
    </p>
    ...
    <p class="case">
      case2-3-3 默认插槽 传多个值 父组件接收一个对象并渲染 提供内容替换内容
    </p>
    ...
    <p class="case">
      case2-3-4 默认插槽 传多个值 父组件接收到一个对象并解构 渲染数据 提供内容替换内容
    </p>
    ...
    <p class="case">
      case2-3-5 具名插槽 传多个值 父组件接收到一个对象并解构 渲染数据 提供内容替换内容
    </p>
